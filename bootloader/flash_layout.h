...
#define FLASH_BASE_ADDRESS              (FLASH_AREA_0_OFFSET)
#define FLASH_REGION_1_MAX              (0x0803FFFF)
...
//#define DISABLE_SST_ITS_FEATURE

#ifdef DISABLE_SST_ITS_FEATURE 
...
#define TFM_NV_COUNTERS_AREA_ADDR    (FLASH_AREA_SCRATCH_OFFSET + \
                                         FLASH_AREA_SCRATCH_SIZE)
#define TFM_NV_COUNTERS_AREA_SIZE    0x800 
#define TFM_NV_COUNTERS_SECTOR_ADDR  (TFM_NV_COUNTERS_AREA_ADDR +  TFM_NV_COUNTERS_AREA_SIZE)//NOTE AR: this address was used to make sure it aligned with pagesTFM_NV_COUNTERS_AREA_ADDR
#define TFM_NV_COUNTERS_SECTOR_SIZE  0x800

/* FIXME: Use SRAM2 memory to store RW data */
#define S_RAM_ALIAS_BASE  (TFM_NV_COUNTERS_SECTOR_ADDR + TFM_NV_COUNTERS_SECTOR_SIZE)
#define NS_RAM_ALIAS_BASE (S_RAM_ALIAS_BASE + TFM_NV_COUNTERS_SECTOR_SIZE)

#if (NS_RAM_ALIAS_BASE + TFM_NV_COUNTERS_SECTOR_SIZE) > FLASH_REGION_1_MAX
#error Allocated FLASH ROM exceeds limit 
#endif
